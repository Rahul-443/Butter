    ...
    public Spannable getformattedText(String whichWord, String queryType, String textData, Context context) {
        ...
        if (textData != null) {
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.shortDefinitions), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 16, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 16, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorShortDefinitions)), i, i + 16, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.definitions), i + 1)) != -1; i++ ) {
                if (textData.substring(i - 2, i).equals(". ")) {
                    s.setSpan(new TypefaceSpan("sans-serif"), i - 3, i + 11, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    s.setSpan(new StyleSpan(Typeface.BOLD), i - 3, i + 11, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    //s.setSpan(new UnderlineSpan(), i - 3, i + 11, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorDefinition)), i - 3, i + 11, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.synonyms), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 8, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 8, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorSynonym)), i, i + 8, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.grammaticalFeatures), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 19, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 19, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorGrammaticalFeatures)), i, i + 19, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }

            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.phrases), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 6, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 6, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorPhrases)), i, i + 6, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }

            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.semanticClasses), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 22, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 22, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorSemanticClasses)), i, i + 22, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }

            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.domainClasses), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 13, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 13, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorDomainClasses)), i, i + 13, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.notes), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 8, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 8, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorNotes)), i, i + 8, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
