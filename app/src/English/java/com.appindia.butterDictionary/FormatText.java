    ...
    public Spannable getformattedText(String whichWord, String queryType, String textData, Context context) {
        ...
        if (textData != null) {
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.shortDefinitions), i + 1)) != -1; i++ ) {
                ...
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorShortDefinitions)), i, i + 17, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.examples), i + 1)) != -1; i++ ) {
                ...
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorExample)), i, i + 8, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.grammaticalFeatures), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 20, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 20, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorGrammaticalFeatures)), i, i + 20, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.phrases), i + 1)) != -1; i++ ) {
                ...
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorPhrases)), i, i + 7, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.semanticClasses), i + 1)) != -1; i++ ) {
                ...
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorSemanticClasses)), i, i + 16, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }

            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.domainClasses), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 14, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 14, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorDomainClasses)), i, i + 14, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.notes), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 5, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 5, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorNotes)), i, i + 5, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
