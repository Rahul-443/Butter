    ...
    public Spannable getformattedText(String whichWord, String queryType, String textData, Context context) {
        ...
        if (textData != null) {
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.shortDefinitions), i + 1)) != -1; i++ ) {
                ...
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorShortDefinitions)), i, i + 13, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.examples), i + 1)) != -1; i++ ) {
                ...
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorExample)), i, i + 6, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.synonyms), i + 1)) != -1; i++ ) {
                ...
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorSynonym)), i, i + 14, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.grammaticalFeatures), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 24, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 24, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorGrammaticalFeatures)), i, i + 24, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }

            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.phrases), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 10, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 10, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorPhrases)), i, i + 10, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }

            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.semanticClasses), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 13, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 13, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorSemanticClasses)), i, i + 13, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.notes), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 10, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 10, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorNotes)), i, i + 10, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
