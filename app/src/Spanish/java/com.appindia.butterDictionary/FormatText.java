        ...
        if (textData != null) {
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.definitions), i + 1)) != -1; i++ ) {
                if (textData.substring(i - 2, i).equals(". ")) {
                    s.setSpan(new TypefaceSpan("sans-serif"), i - 3, i + 12, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    s.setSpan(new StyleSpan(Typeface.BOLD), i - 3, i + 12, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    //s.setSpan(new UnderlineSpan(), i - 3, i + 11, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorDefinition)), i - 3, i + 12, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.examples), i + 1)) != -1; i++ ) {
                ...
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorExample)), i, i + 11, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.semanticClasses), i + 1)) != -1; i++ ) {
                ...
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorSemanticClasses)), i, i + 17, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }

            for (int i = -1; (i = textData.indexOf(context.getResources().getString(R.string.domainClasses), i + 1)) != -1; i++ ) {
                s.setSpan(new TypefaceSpan("sans-serif"), i, i + 17, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new StyleSpan(Typeface.BOLD), i, i + 17, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                s.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.colorDomainClasses)), i, i + 17, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
